 ...
 */
public class Http extends RubyObject {
    ...
    private static ObjectAllocator ALLOCATOR = new ObjectAllocator() {
        public IRubyObject allocate(Ruby runtime, RubyClass klass) {
            return new Http(runtime, klass);
        }
    };

    public static void createHttp(Ruby runtime) {
        RubyModule mThin = runtime.defineModule("Thin");
        mThin.defineClassUnder("InvalidRequest",runtime.getClass("IOError"),runtime.getClass("IOError").getAllocator());

        CallbackFactory cf = runtime.callbackFactory(Http.class);

        RubyClass cHttpParser = mThin.defineClassUnder("HttpParser",runtime.getObject(),ALLOCATOR);
    ...
    public Http(Ruby runtime, RubyClass clazz) {
        super(runtime,clazz);
        this.runtime = runtime;
        this.eHttpParserError = (RubyClass)runtime.getModule("Thin").getConstant("InvalidRequest");
        this.hp = new HttpParser();
    ...
    private HttpParser.FieldCB http_field = new HttpParser.FieldCB() {
            public void call(Object data, int field, int flen, int value, int vlen) {
                ...
                v = RubyString.newString(runtime, new ByteList(Http.this.hp.parser.buffer,value,vlen));
                f = RubyString.newString(runtime, "HTTP_");
                ByteList b = new ByteList(Http.this.hp.parser.buffer,field,flen);
    ...
    private HttpParser.ElementCB request_method = new HttpParser.ElementCB() {
    ...
    private HttpParser.ElementCB request_uri = new HttpParser.ElementCB() {
            public void call(Object data, int at, int length) {
                RubyHash req = (RubyHash)data;
    ...
    private HttpParser.ElementCB fragment = new HttpParser.ElementCB() {
            public void call(Object data, int at, int length) {
                RubyHash req = (RubyHash)data;
    ...
    private HttpParser.ElementCB request_path = new HttpParser.ElementCB() {
            public void call(Object data, int at, int length) {
                RubyHash req = (RubyHash)data;
    ...
    private HttpParser.ElementCB query_string = new HttpParser.ElementCB() {
            public void call(Object data, int at, int length) {
                RubyHash req = (RubyHash)data;
    ...
    private HttpParser.ElementCB http_version = new HttpParser.ElementCB() {
            public void call(Object data, int at, int length) {
                RubyHash req = (RubyHash)data;
                RubyString val = RubyString.newString(runtime,new ByteList(hp.parser.buffer,at,length));
    ...
    private HttpParser.ElementCB header_done = new HttpParser.ElementCB() {
            public void call(Object data, int at, int length) {
                RubyHash req = (RubyHash)data;
